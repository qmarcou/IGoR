...
include::./docs/asciidoc/general/installation.adoc[]

include::./docs/asciidoc/general/workflow.adoc[]

include::./docs/asciidoc/general/runtimes.adoc[]

include::./docs/asciidoc/general/general_commands.adoc[]
...
include::./docs/asciidoc/alignments/alignments.adoc[]

include::./docs/asciidoc/inference/inference.adoc[]

include::./docs/asciidoc/outputs/outputs.adoc[]

include::./docs/asciidoc/generation/generation.adoc[]

include::./docs/asciidoc/commands_examples/general.adoc[]

include::./docs/asciidoc/general/advanced_usage.adoc[]

include::./docs/asciidoc/general/cpp_interface.adoc[]

include::./docs/asciidoc/general/python_interface.adoc[]
